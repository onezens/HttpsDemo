...
{
    AFHTTPSessionManager *manager = [[AFHTTPSessionManager alloc] initWithBaseURL:[NSURL URLWithString:@"https://api.onezen.cc"]];
    //    设置超时时间
...
- (BOOL)extractIdentity:(SecIdentityRef*)outIdentity andTrust:(SecTrustRef *)outTrust fromPKCS12Data:(NSData *)inPKCS12Data {
    ...
    NSDictionary *optionsDictionary = [NSDictionary dictionaryWithObject:@"123123"
